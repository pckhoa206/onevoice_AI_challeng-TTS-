...
100% Verified Production Winning Specs:
  ...
  4. vector_estimator_w8a16   (--compute_unit cpu | noisy_latent: 1 x 144 x 100 float32, text_emb: 1 x 256 x 64 float32, style_ttl: 1 x 50 x 256 float32, latent_mask: 1 x 1 x 100 float32, text_mask: 1 x 1 x 64 float32, current_step: 1 float32, total_step: 1 float32) -> SUCCESS
...
def main():
    ...
    inf_voc.set_name("[OFFICIAL_WINNER] Supertonic3_vocoder_w8a16")
    ...
    inf_dp.set_name("[OFFICIAL_WINNER] Supertonic3_duration_predictor_w8a16")
    ...
    inf_te.set_name("[OFFICIAL_WINNER] Supertonic3_text_encoder_w8a16")
    ...
    inf_ve.set_name("[OFFICIAL_WINNER] Supertonic3_vector_estimator_w8a16")
