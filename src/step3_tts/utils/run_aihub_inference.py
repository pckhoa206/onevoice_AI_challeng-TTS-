...
Exact Verified Working Specs:
  ...
  3. text_encoder_w8a16       (text_ids: 1 x 64 int64, style_ttl: 1 x 50 x 256 float32, text_mask: 1 x 1 x 64 float32)
...
def main():
    ...
    inf_voc.set_name("[OFFICIAL_SUCCESS] Supertonic3_vocoder_w8a16")
    ...
    inf_dp.set_name("[OFFICIAL_SUCCESS] Supertonic3_duration_predictor_w8a16")
    ...
    inf_te.set_name("[OFFICIAL_SUCCESS] Supertonic3_text_encoder_w8a16")
    ...
    inf_ve.set_name("[OFFICIAL_SUCCESS] Supertonic3_vector_estimator_w8a16")
