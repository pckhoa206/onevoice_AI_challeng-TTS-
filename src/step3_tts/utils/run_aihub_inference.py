...
Configured with exact matching tensor input names & shapes:
  1. vocoder_w8a16            (latent: 1 x 144 x 100 float32)
  2. text_encoder_w8a16       (text_ids: 1 x 64 int64, style_ttl: 1 x 50 x 256 float32, text_mask: 1 x 1 x 64 float32)
  3. duration_predictor_w8a16 (text_ids: 1 x 64 int64, style_dp: 1 x 50 x 256 float32, text_mask: 1 x 1 x 64 float32)
  4. vector_estimator_w8a16   (noisy_latent: 1 x 144 x 100 float32, text_emb: 1 x 256 x 100 float32, style_ttl: 1 x 50 x 256 float32, latent_mask: 1 x 1 x 100 float32, text_mask: 1 x 1 x 100 float32, current_step: 1 float32, total_step: 1 float32)
...
def main():
    ...
    inf_voc.set_name("[OFFICIAL_INFERENCE] Supertonic3_vocoder_w8a16_PERFECT")
    ...
    inf_te.set_name("[OFFICIAL_INFERENCE] Supertonic3_text_encoder_w8a16_PERFECT")
    ...
    style_dp_data = np.random.randn(1, 50, 256).astype(np.float32)
    ...
    inf_dp.set_name("[OFFICIAL_INFERENCE] Supertonic3_duration_predictor_w8a16_PERFECT")
    ...
    inf_ve.set_name("[OFFICIAL_INFERENCE] Supertonic3_vector_estimator_w8a16_PERFECT")
